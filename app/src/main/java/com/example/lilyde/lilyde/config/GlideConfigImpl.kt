package com.example.lilyde.config
...
class GlideConfigImpl private constructor(builder: Builder) : ImageConfig() {
    ...
    val diskCachePool: DiskCachePool?
    ...
    class Builder {
        ...
        var imageRadius = 0
        var blurValue = 0
        var diskCachePool: DiskCachePool? = null
        ...
        fun diskCachePool(diskCachePool: String): Builder{
            this.diskCachePool = DiskCachePool()
            return this
        }
    ...
    init {
        ...
        diskCachePool = builder.diskCachePool
